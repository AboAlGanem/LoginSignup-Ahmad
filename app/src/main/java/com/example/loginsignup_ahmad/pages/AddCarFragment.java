...
public class AddCarFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Register image picker launcher during fragment creation
    ...
    private void connectComponents() {
        ...
        img.setOnClickListener(view -> imagePickerLauncher.launch("image/*"));
        ...
        btnAddCar.setOnClickListener(view -> {
            ...
            Car car = new Car(nameCar, horse_power, owners, phone, car_num, manufacturer,
                    car_model, test, kilometre, engine_capacity, gear_shifting_model, price,
